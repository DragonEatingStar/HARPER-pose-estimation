...
The baseline now relies on the lightweight [LiteHRNet](https://arxiv.org/abs/2104.06403) architecture and uses the depth maps captured by the [Spot](https://bostondynamics.com/products/spot/) to estimate the 3D pose of the partially-visible human body.
